...
ActiveRecord::Schema[8.0].define(version: 2024_12_09_135628) do
  ...
  create_table "meal_order_burgers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["drink_id"], name: "index_meal_order_burgers_on_drink_id"
  ...
  create_table "meal_order_french_fries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["drink_id"], name: "index_meal_order_french_fries_on_drink_id"
  ...
  add_foreign_key "meal_order_burgers", "drinks"
  ...
  add_foreign_key "meal_order_french_fries", "drinks"
